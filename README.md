...
- **Unified curve ↔ source-color model** — curve points ARE source colors. Dragging a curve point updates the source color list live and vice versa. Click a curve to add a key color; right-click a point to remove it.
- **Multiple source colors** per scale with automatic curve fitting and snap-to-step on drag release
